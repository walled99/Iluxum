      ...
      <section className="container-custom max-w-3xl mx-auto">
        <div className="prose prose-ink max-w-none space-y-12">
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-ink italic">Agreement to Terms</h2>
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-ink italic">Product Quality & Authenticity</h2>
            <p className="font-body text-ink/70 leading-relaxed">
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-ink italic">Ordering & Payment</h2>
            <p className="font-body text-ink/70 leading-relaxed">
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-ink italic">Intellectual Property</h2>
            <p className="font-body text-ink/70 leading-relaxed">
