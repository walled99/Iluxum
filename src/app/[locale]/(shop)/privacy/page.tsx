      ...
      <section className="container-custom max-w-3xl mx-auto">
        <div className="prose prose-ink max-w-none space-y-12">
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-primary italic">Introduction</h2>
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-primary italic">Data Collection</h2>
            <p className="font-body text-primary/80 leading-relaxed">
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-primary italic">Information Use</h2>
            <p className="font-body text-primary/80 leading-relaxed">
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-3xl font-bold text-primary italic">Security</h2>
            <p className="font-body text-primary/80 leading-relaxed">
